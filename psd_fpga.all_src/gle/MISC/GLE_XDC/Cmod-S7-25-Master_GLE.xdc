...
#
# Need to add the following so synthesis tool doesn't optimize our delay away
#

# set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -of_objects [get_cells Delay]]
